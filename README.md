...
Teleport yourself to dimensions by point in air/blocks, or teleport other players/objects by pointing at them.

There are also crafable "teleport blocks" (click to teleport, and works with mesecons)

All teleported players that do not have the "dimensions" privilege will get there spawnpoint and home set in the new dimension (using "beds" and "sethome")
They can't get back unless they teleport somehow or have/have made a "teleport block"

Players can't see or hear players from "other dimensions" or if they are 800 blocks away

You can change settings in the ```init.lua``` file
